					...
					<div id="panel-1" class="panel panel-info">
						<div class="panel-heading">
							<span class="title elipsis">
								<strong class="text-black"> <i class="fa fa-gear"> </i> MANAGED Applicant</strong> <!-- panel title -->
							</span>
							...
							<div id="printMe">
								...
								<?php 
									...
									{?>
										 ...
										 <td><?=$object->eachApplicantResult($result['user_id']);?></td>
										 ...
										 <td>
										 	<div class="btn-group">
												...
												<li><a href="view_applicant.php?id=<?php echo htmlentities($result['user_id']);?>"><i class="fa fa-eye"></i> View</a></li>
												<li><a href="kk.php" onclick ="return confirm('Sure to shortlist?')"><i class="fa fa-check-square"></i> shortList</a></li>
												<li class="divider"></li>
												<li><a href="#"><i class="fa fa-trash"></i> Cancel</a></li>
												</ul>
											</div>
											</td>
										 <td></td>
